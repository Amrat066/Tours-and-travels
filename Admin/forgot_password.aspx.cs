...
public partial class Admin_forgot_password : System.Web.UI.Page
{
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        qry = "select *from Admin_master where Email='" + txt_email.Text + "'";
        ...
        if (dr.HasRows)
        {
            ...
            smtp.Credentials = new System.Net.NetworkCredential("travellersreview11@gmail.com", "travellerss@123");
            smtp.Port = 587; //465
            smtp.EnableSsl = true;
            smtp.Send(mail);
            cn.Close();
            cn.Open();
            qry = "update Admin_master set Password='" + pass + "' where Email='" + txt_email.Text + "'";
            cmd = new SqlCommand(qry, cn);
            cmd.ExecuteNonQuery();
            cn.Close();
