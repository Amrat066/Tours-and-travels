<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_master.master" AutoEventWireup="true" CodeFile="Edit_Tour_details.aspx.cs" Inherits="Admin_Default" %>
                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="row">
                                                <div class="input-field col s12">
                                                 ...
                                                 <asp:TextBox ID="txt_pname" runat="server" class="validate"></asp:TextBox>
                                     ...
                                     <div class="row">
                                                 ...
                                                 <asp:TextBox ID="txt_desc" runat="server" class="validate"></asp:TextBox>
                                    ...
                                    <div class="row">
                                                 ...
                                                 <asp:TextBox ID="txt_price" runat="server" class="validate"></asp:TextBox>
                                     ...
                                     <div class="row">
                                                 <div class="input-field col s12">
                                                 <%--<input id="price" type="text" class="validate">--%>
                                                 <asp:TextBox ID="txt_discount" runat="server" class="validate"></asp:TextBox>
