<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_master.master" AutoEventWireup="true" CodeFile="hotel_details.aspx.cs" Inherits="Admin_Default" %>
                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="row">
                                                <div class="input-field col s12">
                                                 ...
                                                 <asp:TextBox ID="txt_hname" runat="server" class="validate" required=""></asp:TextBox>
                                     ...
                                     <div class="row">
                                                 ...
                                                 <asp:TextBox ID="txt_htype" runat="server" class="validate" required=""></asp:TextBox>
