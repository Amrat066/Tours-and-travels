<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_master.master" AutoEventWireup="true" CodeFile="tour_exclusion.aspx.cs" Inherits="Admin_Default" %>
                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                                 ...
                                                 <asp:TextBox ID="txt_exclusion" runat="server" class="validate" required=""></asp:TextBox>
