<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_master.master" AutoEventWireup="true" CodeFile="visacountry.aspx.cs" Inherits="Admin_Default" %>
                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="row">
                                                <div class="input-field col s12">
                                                 ...
                                                 <asp:TextBox ID="txt_country" runat="server" class="validate" required=""></asp:TextBox>
                                                 <label for="hotel name">Country Name</label>
                                                </div>
                                    </div> 
                                     <div class="row">
                                                <div class="input-field col s12">
