<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Passport.aspx.cs" Inherits="User_master_Passport" %>
...
<body>
	...
	<section>
		<div class="rows inner_banner inner_banner_1">
			<div class="container">
				<h2><span></span>See the details of passport</h2>
				<ul>
					<li><a href="#inner-page-title">Home</a>
					</li>
					<li><i class="fa fa-angle-right" aria-hidden="true"></i> </li>
					<li><a href="#inner-page-title" class="bread-acti">passport</a>
					</li>
				</ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <center><h1><u>***PASSPORT DETAILS***</u></h1></center>
                                </div>
                        <div class="tab-inn">
