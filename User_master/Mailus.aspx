<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mailus.aspx.cs" Inherits="User_master_Mailus" %>
...
<!-- Mirrored from rn53themes.net/themes/demo/travelz/places.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Jun 2020 16:54:24 GMT -->
<head>
	...
	<![endif]-->
<%--    <link href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js" type="text/javascript" />--%>
    <%--<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.css" rel="Stylesheet" />--%>
    <script src="Sweetalert/JScript.js" type="text/javascript"></script>
    <link href="Sweetalert/StyleSheet.css" rel="stylesheet" type="text/css" />
    <script>
        function alertme() {
            swal("thank you for requesting!", "our team will contact you shortly!", "success");
        }
...
<body>
                        ...
                        <div class="main-menu">
                            <ul>
                                ...
                                <li><a href="passport.aspx">Passport</a>
                                  ...
                                  <li><a href="visadetails.aspx">Visa</a>
                                </li>
	...
	<section>
			...
			<div class="tr-regi-form">
				<h4><u>**Mail US**</u></h4>
				<form id="Form1" runat="server" class="contact__form">
        
					<div class="row">
						<div class="input-field col s12">
							<%--<input type="name" class="validate">--%>
                            <asp:TextBox ID="txt_name"  required="" runat="server" class="validate"></asp:TextBox>
                    ...
                    <div class="row">
						<div class="input-field col s12">
                            ...
                            <asp:TextBox ID="txt_email"  required="" runat="server" class="validate"></asp:TextBox>
                    ...
                    <div class="row">
						<div class="input-field col s12">
							<%--<input type="name" class="validate">--%>
                            <asp:TextBox ID="txt_mobno"  required="" runat="server" class="validate"></asp:TextBox>
                     ...
                     <div class="row">
						<div class="input-field col s12">
							<%--<input type="name" class="validate">--%>
                            <asp:TextBox ID="txt_msg"  required="" runat="server" class="validate"></asp:TextBox>
							<label>Message</label>
						</div>
					</div>
					<div class="row">
						<div class="input-field col s12">
                            ...
                            <asp:Button ID="btn_submit" runat="server" Text="Send your request now" class="waves-effect waves-light btn-large full-btn" onclick="btn_submit_Click"></asp:Button>
					</div>
                    </div> 
				</form> 
