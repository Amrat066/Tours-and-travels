<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sign_in.aspx.cs" Inherits="User_master_Sign_in" %>
	...
	<section>
		<div class="tr-register">
			<div class="tr-regi-form">
                  ...
                  <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
					<div class="row">
						<div class="input-field col s12">
                            ...
                            <asp:TextBox ID="txt_pass" type="password" required="" runat="server" class="validate"></asp:TextBox>
				...
				<p><a href="forgotten_password.aspx">forgot password</a> | Are you a new user ? <a href="Sign_up.aspx">Register</a>
				</p>
