<%@ Page Language="C#" AutoEventWireup="true" CodeFile="visadetails.aspx.cs" Inherits="User_master_visadetails" %>
...
<body>
	...
	<section>
			...
			<div class="tr-regi-form v2-search-form">
				<h4><span><u>Visa Process</u></span></h4>
				
                <form id="frm1" runat="server" class="contact__form">     
                        <div class="row">
						    <div class="input-field col s6">
                                <asp:Image ID="country_flag" height="230px" width="490px" runat="server" />
                            </div>
                        </div>
                        <div class="row">
							<div class="input-field col s6">
                            <asp:Label ID="Label1" runat="server" Text="please select your country"></asp:Label>
          ...
          <div class="row">
						    <div class="input-field col s12">
                  <b><asp:Label ID="lbltime" runat="server" Text=""></asp:Label></b>
            </div>
          </div>
    </form>
    </div>
