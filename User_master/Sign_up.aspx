<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sign_up.aspx.cs" Inherits="User_master_Sign_up" %>
        ...
        <%--<div class="top-logo" data-spy="affix" data-offset-top="250">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wed-logo">
                            <img src="images/sunshine (3).jfif" height="50px" width ="180px" alt="" />
	...
	<section>
		<div class="tr-register">
			<div class="tr-regi-form">
				...
				<form runat="server" class="col s12">
					<div class="row">
						<div class="input-field col s12">
							<%--<input type="username" class="validate">--%>
                            <asp:TextBox ID="txt_uname" runat="server" class="validate" required=""></asp:TextBox>
                  ...
                  <div class="row">
                        ...
                        <asp:TextBox ID="txt_password" runat="server" type="password" class="validate" required=""></asp:TextBox>
                   ...
                   <div class="input-field col s12">
		                   <%--<input type="email" class="validate">--%>
                           <asp:TextBox ID="txt_mobile" runat="server" class="validate" required=""></asp:TextBox>
                            <asp:FilteredTextBoxExtender ID="txt_mobile_FilteredTextBoxExtender" 
                         runat="server" Enabled="True" TargetControlID="txt_mobile" FilterType="Numbers">
                          </asp:FilteredTextBoxExtender>
					...
					<div class="row">
						<div class="input-field col s12">
                            ...
                            <asp:Button ID="btn_submit" runat="server" Text="submit" 
                                class="waves-effect waves-light btn-large full-btn" onclick="btn_submit_Click"></asp:Button>
					</div>
                    </div> 
				...
				<p>Are you a already member ? <a href="sign_in.aspx">Click to Login</a>
				</p>
			</div>
		</div>
	</section>
